...
// Vendored verbatim from the Chainlink CRE docs samples:
//   https://docs.chain.link/samples/CRE/ReceiverTemplate.sol
// It is NOT published as an npm package — it ships as copy-paste source with sibling
// files IReceiver.sol + IERC165.sol. Only Ownable comes from a real package (@openzeppelin).
